...
\clip(-4.100471663842028,-0.5) rectangle (3.290690084294631,4.2126654282396805);
...
\clip(-6.208079428623365,-4.88103785801355) rectangle (7,3.330141435297047);
...
\draw[color=uuuuuu] (-2.156689366005456,2.1850068384627845) node [anchor=south east]{$A$};
...
\draw[color=uuuuuu] (2.9266585427509777,1.1243834965981825) node {$B$};
...
\draw[color=uuuuuu] (-0.541866440103506,-2.7454584264213104) node [anchor=east]{$C$};
...
\clip(-6.46924489473801,-6.191518174827493) rectangle (3.023218480966734,3.967438049025187);
...
\draw [line width=0.5pt, draw=myviolet] (-1.522457840938142,2.584980101)-- (2.7978098337965394,1.082709625851447);
\draw [line width=0.5pt,domain=-6.46924489473801:-1.522457840938142, draw=myviolet] plot(\x,{(-5.66929687567797-0*\x)/-2.193168478737922});
\draw [line width=0.5pt, draw=myviolet] (2.79780983379654,1.082709625851447)-- (0.6142485544560807,-2.9364432079215526);
\draw [line width=0.5pt,domain=-6.46924489473801:0.6142485544560807, draw=myviolet] plot(\x,{(--3.5519844101822113-0.9249782549023493*\x)/-1.0161333432758997});

% orange

\draw [line width=0.5pt, draw=myindigo] (-1.5256042352006474,2.58312441)-- (2.7994604216279537,1.0784346747664604);
\draw [line width=0.5pt,domain=-6.46924489473801:-1.5256042352006474, draw=myindigo] plot(\x,{(-5.657099504847531-0*\x)/-2.190022084475417});
\draw [line width=0.5pt, draw=myindigo] (2.799460421627954,1.0784346747664604)-- (0.6016966061149287,-2.9390408629669946);
\draw [line width=0.5pt,domain=-6.46924489473801:0.6016966061149287, draw=myindigo] plot(\x,{(--3.549434531558556-0.9218696303918201*\x)/-1.0189544287751555});

%yellow

\draw [line width=0.5pt, draw=myblue] (-1.5290087088629778,2.581110685)-- (2.8012343878394748,1.0738183758837456);
\draw [line width=0.5pt,domain=-6.46924489473801:-1.5290087088629778, draw=myblue] plot(\x,{(-5.6439020792788295-0*\x)/-2.1866176108130864});
\draw [line width=0.5pt, draw=myblue] (2.8012343878394748,1.0738183758837456)-- (0.5881253151603842,-2.9417866363262135);
\draw [line width=0.5pt,domain=-6.46924489473801:0.5881253151603842, draw=myblue] plot(\x,{(--3.5466675006620205-0.9185051879132415*\x)/-1.0219882402140028});
...
\draw [line width=0.5pt, draw=myyellow] (-1.5389359535390779,2.575204095)-- (2.8063364904842576,1.0604128923096425);
\draw [line width=0.5pt,domain=-6.46924489473801:-1.5389359535390779, draw=myyellow] plot(\x,{(-5.605421944423016-0*\x)/-2.1766903661369863});
\draw [line width=0.5pt, draw=myyellow] (2.806336490484257,1.0604128923096425)-- (0.5486156646238993,-2.9494102550390098);
\draw [line width=0.5pt,domain=-6.46924489473801:0.5486156646238993, draw=myyellow] plot(\x,{(--3.5385513393077326-0.9086906836594855*\x)/-1.0307244950954204});

%indigo

\draw [line width=0.5pt, draw=myorange] (-1.5464879817929291,2.570675966)-- (2.810148103015898,1.05027026955739);
\draw [line width=0.5pt,domain=-6.46924489473801:-1.5464879817929291, draw=myorange] plot(\x,{(-5.576151792125362-0*\x)/-2.169138337883135});
\draw [line width=0.5pt, draw=myorange] (2.8101481030158975,1.05027026955739)-- (0.5186258999216984,-2.9548311586164124);
\draw [line width=0.5pt,domain=-6.46924489473801:0.5186258999216984, draw=myorange] plot(\x,{(--3.532329301618131-0.9012216452518325*\x)/-1.0372614373863676});

%violet

\draw [line width=0.5pt, draw=myred] (-1.5566119463587236,2.564558295)-- (2.8151645805619148,1.0367489495290845);
\draw [line width=0.5pt,domain=-6.46924489473801:-1.5566119463587236, draw=myred] plot(\x,{(-5.536918220115211-0*\x)/-2.1590143733173406});
\draw [line width=0.5pt, draw=myred] (2.8151645805619148,1.0367489495290845)-- (0.4785192094328503,-2.9615906817458355);
\draw [line width=0.5pt,domain=-6.46924489473801:0.4785192094328503, draw=myred] plot(\x,{(--3.5239230968623514-0.8912072824037787*\x)/-1.045878254458771});
...
\draw[color=qqwuqq] (-5.888978881762978,-1.9021283669665343) node [below]{$D(\alpha)$};
\end{scriptsize}
\end{tikzpicture}
}
...
is the path that can be traversed in the least time. In an ideal scenario -- in a vacuum -- the path of least time is the path least distance, the line, as descibed by the equation
...
However, when there are interferences to the path of the light, the path may take a different path, not a straight line, but the path of least time as suggested by Fermat.


\subsection{Snell's law} \label{snells}

The first case of Fermat's principle of optics is when light passes through two different objects. The phase velocity of light is computed as
...
To get the minimum $T$, we can equate $T'(x) = 0$.
...
Equation \eqref{refract} is what we call the law of refraction or {\itshape Snell's law}. Snell's Law is shows the relationship between the incident angle and the refracted angle in two different mediums. 
...
Equating $T'(x) = 0$ to get the minimum value,
...
\end{tabular}
\caption{Visible light wavelengths and their corresponding refractive indices on water}
\end{table}
...
Figure \ref{primary} shows a ray of sunlight entering a spherical raindrop at $A$. Some of the light
...
\subsection{Colors in a primary rainbow} \label{sec:primary}
...
\begin{align*}
\alpha &= \arccos \sqrt{\dfrac{1.3318^2 -1}{3}}\\
&\approx 1.0381
\end{align*}
...
\begin{align*}
D(1.0381) &= \pi + 2(1.0381) - 4\arcsin \left( \dfrac{\sin 1.0381}{1.3318} \right)\\
&\approx 2.4041\\
&\approx 137.7 \degree
\end{align*}
...
\begin{align*}
\alpha &= \arccos \sqrt{\dfrac{1.3435^2 -1}{3}}\\
&\approx 1.0263
\end{align*}
...
\begin{align*}
D(1.0263) &= \pi + 2(1.0263) - 4\arcsin \left( \dfrac{\sin 1.0263}{1.3435} \right)\\
&\approx 2.4334\\
&\approx 139.4 \degree
\end{align*}
...
\centering
\primarycolor
\caption{Colors of the rainbow based on their respective minimum $\alpha$ value and refractive indices.}
\label{fig:primarycolor}
\end{figure}

As observed in the calculations and as visualized in Figure \ref{fig:primarycolor}, the rainbow angle of the red light ($42.3 \degree$) is larger than the rainbow angle of the violet light ($40.6 \degree$). This implies that the rainbow’s color appears red on top, violet on the bottom, and all other visible light wavelengths in between.
...
As mentioned in Section \ref{sec:primary}, $dD/da \approx 0$ implies that light rays converge at that certain angle, meaning that it is the best angle to properly see the rainbow.\\
